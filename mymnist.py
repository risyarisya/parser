...
class MYMNIST(dense_design_matrix.DenseDesignMatrix):
    """
    The MNIST dataset
    ...
    def __init__(self, which_set, center=False, shuffle=False,
        ...
        if control.get_load_data():
            ...
            if which_set == 'train':
                im_path = path + 'CIFAR_MONO_train_data'
                label_path = path + 'CIFAR_MONO_train_label'
            else:
                assert which_set == 'test'
                im_path = path + 'CIFAR_MONO_test_data'
                label_path = path + 'CIFAR_MONO_test_label'
        ...
        super(MYMNIST, self).__init__(topo_view=dimshuffle(topo_view), y=y,
                                    axes=axes, y_labels=None)
...
class MNIST_rotated_background(dense_design_matrix.DenseDesignMatrix):
    ...
    def __init__(self, which_set, center=False):
        ...
        super(MNIST_rotated_background, self).__init__(
            X=X, y=y, y_labels=None, view_converter=view_converter)
